...
module.exports = {
    ...
    async index(req,res){
        ...
        await User.create({name:'Maria', login:'maria', password:'maria', id_team:1, max_season:24, min_season:10, max_record:1, min_record: 1});
        ...
        await Match.create({points:12, id_adversary:2, id_user:1});
        await Match.create({points:24, id_adversary:3, id_user:1});
        await Match.create({points:10, id_adversary:4, id_user:1});
        await Match.create({points:24, id_adversary:5, id_user:1});
